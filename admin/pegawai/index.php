...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fas fa-id-badge ml-1 mr-1"></i> Data Pegawai</h4>
                </div><!-- /.col -->
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = $con->query("SELECT * FROM pegawai a JOIN divisi b ON a.id_divisi = b.id_divisi JOIN jabatan c ON a.id_jabatan = c.id_jabatan ORDER BY tmt DESC");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center" width="13%">
                                                    ...
                                                    <?php include('../../app/detail-pegawai.php'); ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
