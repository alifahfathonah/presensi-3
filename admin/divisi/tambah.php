...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-chart-pie ml-1 mr-1"></i> Tambah Data Divisi</h4>
                </div><!-- /.col -->
                        ...
                        <div class="card-body" style="background-color: white;">
                            <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nm_divisi" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-12">
...
if (isset($_POST['submit'])) {
    ...
    $tambah = $con->query("INSERT INTO divisi VALUES (
        default, 
        '$nm_divisi'
    )");
