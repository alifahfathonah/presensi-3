...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fas fa-door-open ml-1 mr-1"></i> Tambah Data Akses Terlambat Absensi</h4>
                </div><!-- /.col -->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="id_pegawai" class="form-control select2" style="width: 100%;">
                                            ...
                                            <?php $data = $con->query("SELECT * FROM pegawai WHERE is_active = 1 ORDER BY nm_pegawai ASC"); ?>
...
if (isset($_POST['submit'])) {
    ...
    $tambah = $con->query("INSERT INTO telat VALUES (
        default, 
        '$id_pegawai', 
        '$tanggal'
    )");
